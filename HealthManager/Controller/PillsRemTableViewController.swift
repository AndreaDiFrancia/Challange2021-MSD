//
//  PillsRemTableViewController.swift
//  HealthManager
//
...
class PillsRemTableViewController: UITableViewController {

    var reminders: [PillReminder] = []
    ...
    @objc func getReminders() {
        APIManager.shared.getAllPillReminders { (reminders) in
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCellEditingStyle, forRowAt indexPath: IndexPath) {
        ...
        if self.reminders.count > 0 {
            if editingStyle == .delete {
                ...
                APIManager.shared.deletePillReminder(reminderToDelete)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "toPillDetails", let cell = sender as? UITableViewCell {
            
            let indexPath = self.tableView.indexPath(for: cell)
            
            let reminder = self.reminders[(indexPath?.row)!]
            
            DataManager.shared.pillReminderSegue = reminder
