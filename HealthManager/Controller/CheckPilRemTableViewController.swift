//
//  CheckPilRemTableViewController.swift
//  HealthManager
//
...
class CheckPilRemTableViewController: UITableViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        adressLabel.text = DataManager.shared.pillReminderSegue?.dosage
        noteLabel.text = DataManager.shared.pillReminderSegue?.note
        categoryLabel.text = DataManager.shared.pillReminderSegue?.category
